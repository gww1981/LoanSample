...
using Colin.AbpDemo.MultiTenancy;
using Colin.AbpDemo.Web.Menus;
    ...
    public class AbpDemoWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<AbpDemoDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Colin.AbpDemo.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<AbpDemoDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Colin.AbpDemo.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<AbpDemoApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Colin.AbpDemo.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<AbpDemoApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Colin.AbpDemo.Application"));
